    ...
    <div id="main-wrapper">
       ...
       <?php 
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Certification Authorities</h4>
                        ...
                        <div class="d-flex no-block no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Certification Authorities</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Certification Authorities</h4>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM certification_authorities";
                                            ...
                                            ?>
                                            <tr>
                                                <td><a href="viewcerts.php?id=<?php echo $row['authority_id'];?>"><?php echo $row['certification_authority'];?></a></td>
                                                <td><?php echo $row['Manager'];?></td>
                                                <td><?php echo $row['authority_contact'];?></td>
