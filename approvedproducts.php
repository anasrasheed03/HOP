    ...
    <div id="main-wrapper">
       ...
       <?php 
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Approved Products</h4>
            ...
            <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Approved Products</h4>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM products WHERE status=1 ORDER BY product_id";
