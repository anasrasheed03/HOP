    ...
    <div id="main-wrapper">
       ...
       <?php 
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Brand Complaint List</h4>
                        ...
                        <div class="d-flex no-block no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Brand Complaints</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Product Complaints</h4>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM reportproduct ORDER BY id";
                                            ...
                                            <tr>
                                                <td><a href="viewcomplaints.php?id=<?php echo $complaint_id; ?>>"<?php echo $product_name; ?></a></td>
                                                <td><?php echo $reporter_name; ?></td>
                                                <td><?php echo $email; ?></td>
                                                <td><?php echo $date; ?></td>
                                                <td><?php echo $report_subject; ?></td>
                                                <td><?php echo limit_words($report_description,15); ?></td>
