                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM contactinquiry ORDER BY id";
                                            ...
                                            <tr>
                                                <td><a href="viewcomplaint.php?id=<?php echo $contact_id; ?>"><?php echo $name; ?></a></td>
                                                <td><?php echo $email; ?></td>
                                                <td><?php echo $date; ?></td>
                                                <td><?php echo $subject; ?></td>
                                                <td><?php echo limit_words($comments,15); ?></td>
