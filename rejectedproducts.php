    ...
    <div id="main-wrapper">
       ...
       <?php 
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Rejected Products</h4>
                        ...
                        <div class="d-flex no-block no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Rejected Products</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Rejected Products</h4>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM products WHERE status=2 ORDER BY product_id";
