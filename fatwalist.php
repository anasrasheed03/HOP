    ...
    <div id="main-wrapper">
       ...
       <?php 
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Fatwa List</h4>
                        ...
                        <div class="d-flex no-block no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Fatwa List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List of All Fatwas by Ulemas</h4>
                                <div class="table-responsive">
                                    <table id="file_export" class="table table-striped table-bordered display">
                                        ...
                                        <tbody>
                                            <?php 
                                            $search_query="SELECT * FROM fatawa ORDER BY fatwa_id";
                                               ...
                                               $view_veh_result = $mysqli->query($search_query);
                                                 ...
                                                 if ($view_veh_result->num_rows > 0) {
                                                    ...
                                                    $fatwa_title = $row['fatwa_title'];
                                                    $fatwa_question = $row['fatwa_question'];
                                                    $darul_iftah = $row['darul_iftah'];
                                                    $ulema_name = $row['ulema_name'];
                                                    $fatwa_date = $row['fatwa_date'];
                                            ...
                                            <tr>
                                                <td><a href="viewfatwa.php?id=<?php echo $fatwa_id; ?>"><?php echo $fatwa_title; ?></a></td>
                                                <td><?php echo limit_words($fatwa_question,15); ?></td>
                                                <td><?php echo $ulema_name; ?></td>
                                                <td><?php echo $ulema_name; ?></td>
                                                <td><?php echo $fatwa_date; ?></td>
                                                </tr>
                                                                                     <?php
                                            }
                                        }
