                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">View Ulema</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php 
                                                    ...
                                                    $disply_ulema="SELECT * FROM ulema WHERE ulema_id=$uid";

                                                                if ($check_ulema=mysqli_query($mysqli,$disply_ulema))
                                                                  {
                                                                  // Return the number of rows in result set
                                                                  $checku=mysqli_fetch_assoc($check_ulema);
                                                                  }
                                                                  $ukey=$checku['ulkey'];
                                                                  
                                                    $disply_info="SELECT * FROM tbl_login WHERE refkey='$ukey'";
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6><?php echo $checku['ulema_email'];?>
                                        </h6> <small class="text-muted p-t-30 db">Phone</small>
                                <h6><?php echo $checku['ulema_contact'];?></h6> 
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $checku['ulema_name']; ?></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Designation</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $checku['designation']; ?></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Address</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $checku['address']; ?></p>
                                            </div>
                                            </div>
                                            <div class="row">
                                            <div class="col-md-3 col-xs-6"> <strong>Affiliation</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $checku['certification_authority']; ?></p>
                                            </div>
                                            </div>
